...
public class WheelView extends View {
    ...
    Typeface typefaceBold = Typeface.DEFAULT_BOLD;//字体样式，默认是等宽字体

    int textColorOut = 0xFF4D4D4D;
    int textColorCenter = 0xFF333333;
    int dividerColor = 0xFFF0F0F0;
    ...
    public WheelView(Context context, AttributeSet attrs) {
       ...
       /* textColorOut = getResources().getColor(R.color.pickerview_wheelview_textcolor_out);
        ...
        textSize = getResources().getDimensionPixelSize(R.dimen.textSize_larger_big);//默认大小
    ...
    private void initPaints() {
        ...
        paintCenterText.setTypeface(typefaceBold);
