...
import com.yh.base.lib.wheel.BasePickerView;
import com.yh.base.lib.wheel.CustomListener;
import com.yh.base.lib.wheel.WheelOptions;
...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    private LinearLayout rv_top_bar;
    ...
    public static class Builder {
        ...
        private int Size_Submit_Cancel = 14;//确定取消按钮大小
        private int Size_Title = 17;//标题文字大小
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            ...
            rv_top_bar = (LinearLayout)findViewById(R.id.rv_top_bar);
            ...
            //设置文字
            if (!TextUtils.isEmpty(Str_Submit)) {
            ...
            //设置color
            if (Color_Submit != 0) {
                btnSubmit.setTextColor(Color_Submit);
            }
            if (Color_Cancel != 0) {
                btnCancel.setTextColor(Color_Cancel);
            }
            if (Color_Background_Title != 0) {
                rv_top_bar.setBackgroundColor(Color_Background_Title);
            }
...
//            tvTitle.setTextSize(Size_Title);
        ...
        if (Color_Background_Wheel != 0) {
            optionsPicker.setBackgroundColor(Color_Background_Wheel);
        }
