...
/**
 * @description $
 * @date: 2021/5/28 6:36 PM
 * @author: zengbobo
 */
public class YHPrettyFormatStrategy implements FormatStrategy {
    ...
    private YHPrettyFormatStrategy(Builder builder) {
    ...
    public static class Builder {
        ...
        public YHPrettyFormatStrategy build() {
            if (logBorder == null) {
            ...
            return new YHPrettyFormatStrategy(this);
        }
    }
